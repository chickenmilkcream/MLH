...
int main() {
    ...
    string filename = "experiments/phase3_put_runtimes.csv";

    std::ofstream result_file_2;
    result_file_2.open("experiments/phase3_get_runtimes_2.csv");
    ...
    result_file_3.open("experiments/phase3_scan_runtimes_2.csv");
